...
HD_PWD='C:/Users/huyan/Documents/8bitALU_orig01/8bitALU_orig01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log computer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source computer.tcl
