...
HD_PWD='C:/Users/huyan/Documents/8bitALU_orig01/8bitALU_orig01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log computer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source computer.tcl -notrace
